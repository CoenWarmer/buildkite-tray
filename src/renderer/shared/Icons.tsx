  ...
  if (state === 'running') {
    return (
      <div className="flex-shrink-0 w-4 h-4 relative">
        <div className="absolute inset-0 rounded-full bg-buildkite-green/20 animate-ping" />
        <div className="relative w-4 h-4 rounded-full bg-buildkite-green/30 flex items-center justify-center">
          <div className="w-2 h-2 rounded-full bg-buildkite-green" />
        </div>
      </div>
    )
  }
...
export function GearIcon(): React.JSX.Element {
  return (
    <svg
      ...
      width="16"
    >
      <path stroke="currentColor" d="M9 12a3 3 0 1 0 6 0 3 3 0 1 0 -6 0" stroke-width="2"></path>
      <path
